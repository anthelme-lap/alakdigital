...
import { Target, Eye, Award, Zap, Shield, Heart, Compass, Rocket, ArrowRight, Check } from 'lucide-react';
...
const values = [
  { icon: Award, title: 'Excellence', desc: 'Nous visons l\'excellence dans chaque ligne de code et chaque pixel.' },
  { icon: Zap, title: 'Innovation', desc: 'Nous explorons constamment de nouvelles technologies et approches.' },
  { icon: Shield, title: 'Fiabilité', desc: 'Nos solutions sont robustes, testées et conçues pour durer.' },
  { icon: Target, title: 'Performance', desc: 'Nous mesurons et optimisons en continu pour des résultats concrets.' },
  { icon: Heart, title: 'Simplicité', desc: 'La simplicité est notre marque de fabrique. Complexité masquée, usage fluide.' },
  { icon: Compass, title: 'Accompagnement', desc: 'Nous sommes partenaires de nos clients sur le long terme.' },
];
...
const missionVision = [
  {
    ...
    icon: Target,
    label: 'Notre mission',
    title: 'Accompagner la transformation digitale africaine',
    description:
      'Accompagner la transformation digitale des entreprises africaines en concevant des solutions logicielles sur mesure, performantes et adaptées au contexte local.',
    points: [
      'Des solutions sur mesure, jamais génériques',
      'Une technologie au service de la valeur métier',
      'Un impact économique durable pour nos clients',
    ],
  },
  {
    key: 'vision',
    icon: Eye,
    label: 'Notre vision',
    title: 'Être le partenaire tech de référence en Afrique de l\'Ouest',
    description:
      'Devenir le partenaire technologique de référence en Afrique de l\'Ouest pour la conception de solutions digitales innovantes et de qualité internationale.',
    points: [
      'Des produits d\'une qualité internationale',
      'Une innovation adaptée aux réalités locales',
      'Un écosystème tech qui grandit avec ses clients',
    ],
  },
];
...
const team = [
  {
    name: 'Kouassi Aristide',
    role: 'Lead Developer & Co-fondateur',
    image: 'https://images.pexels.com/photos/31422830/pexels-photo-31422830.png?auto=compress&cs=tinysrgb&h=650&w=940',
    tools: ['React', 'TypeScript', 'FastAPI', 'Docker', 'PostgreSQL'],
  },
  {
    name: 'Aminata Bamba',
    role: 'UI/UX Designer & Product Manager',
    image: 'https://images.pexels.com/photos/6497114/pexels-photo-6497114.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    tools: ['Figma', 'Framer', 'Photoshop', 'Notion', 'Miro'],
  },
  {
    name: 'Yao Konan',
    role: 'Backend Engineer',
    image: 'https://images.pexels.com/photos/7562139/pexels-photo-7562139.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    tools: ['Laravel', 'Python', 'Redis', 'MySQL', 'Nginx'],
  },
  {
    name: 'Fatou Diarra',
    role: 'Mobile Developer',
    image: 'https://images.pexels.com/photos/6497112/pexels-photo-6497112.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    tools: ['Flutter', 'Dart', 'Android', 'iOS', 'Firebase'],
  },
];

export function AboutPage() {
  const [activeTab, setActiveTab] = useState<'mission' | 'vision'>('mission');
  const active = missionVision.find((mv) => mv.key === activeTab)!;
    ...
    <>
          ...
          <div className="lg:sticky lg:top-24">
            <div className="flex flex-col gap-3">
              {missionVision.map((mv) => (
                <button
                  key={mv.key}
                  onClick={() => setActiveTab(mv.key as 'mission' | 'vision')}
                ...
                >
                  ...
                  >
                    <mv.icon className="h-6 w-6" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className={`text-xs font-semibold uppercase tracking-wide mb-1 ${activeTab === mv.key ? 'text-primary-400' : 'text-ink-400'}`}>
                      {mv.label}
                    </div>
                    <div className={`text-base font-bold leading-tight ${activeTab === mv.key ? 'text-white' : 'text-ink-900'}`}>
                      {mv.title}
                    </div>
                  </div>
                </button>
      ...
      <Section className="bg-ink-50/50">
        <div className="grid lg:grid-cols-3 gap-8">
          {[
            { icon: Target, title: 'Expertise', desc: 'Une équipe pluridisciplinaire maîtrisant toute la chaîne digitale, du frontend à l\'infrastructure.' },
            { icon: Rocket, title: 'Approche', desc: 'Une méthodologie structurée et collaborative, centrée sur les objectifs métier de nos clients.' },
            { icon: Award, title: 'Qualité', desc: 'Un engagement fort sur la qualité du code, du design et de l\'expérience utilisateur finale.' },
          ].map((item, i) => (
